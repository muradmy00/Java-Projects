...
public class AddTeacher extends JFrame implements ActionListener{
    ...
    AddTeacher()
    {
        ...
        lblempId.setBounds(30,220,200,30);
        lblempId.setFont(new Font("serif",Font.BOLD,20));
        add(lblempId);
        
        labelempId = new JLabel("10115103"+first3);
        ...
        String degree[] = {"BSc","MBA","MCom","BS","BDM","BSS"};
    ...
    public void actionPerformed(ActionEvent ae)
    {
        if(ae.getSource() == submit)
        {
            ...
            try {
                ...
                String query = "insert into teacher values('"+name+"' , '"+fname+"', '"+rollno+"', '"+dob+"', '"+address+"', '"+phone+"', '"+email+"', '"+x+"', '"+xii+"', '"+nid+"', '"+course+"', '"+degree+"')";
