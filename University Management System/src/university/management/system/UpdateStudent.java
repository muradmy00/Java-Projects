...
public class UpdateStudent extends JFrame implements ActionListener{
    ...
    UpdateStudent() {
        ...
        JLabel lblbranch = new JLabel("Degree");
        ...
        try {
            ...
            while(rs.next()) {
                ...
                labelaadhar.setText(rs.getString("nid"));
                labelrollno.setText(rs.getString("rollno"));
                tfcourse.setText(rs.getString("course"));
                tfbranch.setText(rs.getString("degree"));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == submit) {
            ...
            try {
                String query = "update student set address='"+address+"', phone='"+phone+"', email='"+email+"', course='"+course+"', degree='"+branch+"' where rollno='"+rollno+"'";
                Conn con = new Conn();
